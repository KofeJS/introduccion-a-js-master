...
//const cantidadDeDedos = 20;
// alert("Tengo " + cantidadDeDedos + " dedos");
...
console.log("10x3=" + resultadoMultiplicacion);
*/
/*
    Funciones
    =========
...
/*
let functionNumero = 10
function duplicar(functionNumero) {
    return functionNumero * 2;
};

console.log(duplicar(functionNumero));
*/

// let edadUsuario = prompt("Qué edad tiene?");

// console.log("El usuario tiene " + edadUsuario);

// let nombreUsuario = prompt("Cómo te llamas?");

// function saludar(nombreUsuario) {return "Hola " + nombreUsuario +", bienvenido a la página!";}
...
// let edadUsuario = "Tu edad es: " + restar(anioActual, anioNacimiento)

// console.log(edad(edadUsuario))
/*
let salarioAnual = prompt("Cuánto ganás al año?")
    let salarioMensual = dividir(salarioAnual, 12)
        let salarioSemana = dividir(salarioAnual, 54)
            let salarioDiario = dividir(salarioAnual, 365)
                let salarioPorHora = dividir(salarioAnual, 8760) 
...
console.log("Ganás " + salarioMensual + " al mes")
console.log("Ganás " + salarioSemana + " al la semana")
console.log("Ganás " + salarioDiario + " al día")
console.log("Ganás " + salarioPorHora + " por hora")
*/
/*
...
function tareaIfElse(operadorAritmetico) {
    
    let number1 = 6;
    let number2 = 3;
            
    if (operadorAritmetico === "+") {
        console.log("El resultado de " + number1 + "+" + number2 + "=" + sumar(number1, number2));
    } else {
        console.log("El resultado de " + number1 + "-" + number2 + "=" + restar(number1, number2));
    };
}

console.log(tareaIfElse(operador1))
*/
/*
function sumar(numero1, numero2) {
    return numero1 + numero2;
...
/*
const operador = prompt("Seleccione entre '+', '-', '*' o '/'")
let number1 = 6;
let number2 = 3;
let resultado;
...
if (operador === "+") {
    ...
    console.log("Perdón, no conozco el operador")
}
*/
/*
...
/*
const soyMayorDeEdad = false;

console.log(`Soy mayor de edad? ${soyMayorDeEdad}`)
console.log(`No soy mayor de edad? ${!soyMayorDeEdad}`)
*/
////////////////////////////////////////////////////////////////////////////
