...
for (let A = 0; A < mediaLinks.length; A++) {
    console.log(mediaLinks[A].innerText);
}
...
nuestroTitulo.textContent = "Chocotorta";
console.log(nuestroTitulo.textContent)
...
let $imagenPagina = document.querySelector("img")
...
let $textoSubtitulo = document.querySelector("h2")
$textoSubtitulo.style.backgroundColor = "red";
...
const imagenCabeceraNodo = document.createElement('img');
    imagenCabeceraNodo.src = "img/logo_AP.jpg";
    imagenCabeceraNodo.style.maxWidth = "15%";
nodoHeader.appendChild(imagenCabeceraNodo);
